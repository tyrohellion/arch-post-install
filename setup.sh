...
# === Run protonup-rs to install proton-ge ===
run_protonup() {
  info "Please install proton-ge locally for bakkesmod to work."
  protonup-rs
  success "protonup-rs finished."
}
...
customize_bashrc() {
  ...
  add_line 'alias rl-launch="echo BAKKES=1 PROMPTLESS=1 PROTON_ENABLE_WAYLAND=1 %command%"'
